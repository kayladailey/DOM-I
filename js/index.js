...
domImg.src = "pictures//ddomimg.jpg"
section.append(domImg)


const titleColor = document.querySelectorAll('h4')
titleColor.forEach ((titleColor) => {
 titleColor.style.fontSize
});

const title = document.querySelectorAll('h4');

title [0].textContent = 'Features';
title [1].textContent = 'About';
title [2].textContent = 'Services';
title [3].textContent = 'Product';
title [4].textContent = 'Vision';
title [5].textContent = 'Contact';
...
par [0].textContent = "Features content elementum magna eros, ac posuere elvit tempus et. Suspendisse vel tempus odio, interdutm nisi.Suspendisse eu ornare nisl. Nullam convallis augue justo, at imperdiet metus scelerisque quis.";
...
par [5].textContent  = "123 Way 456 Street";
par [6].textContent  = "Somewhere, USA";
par [7].textContent  = "1 (888) 888-8888";
